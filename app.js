...
function Search() {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      document.getElementById("condition_text").textContent =
        data.current.condition.text;
      document.getElementById(
        "condition_icon"
      ).innerHTML = `<img src="${data.current.condition.icon}" alt="${data.current.condition.text}">`;
      document.getElementById(
        "last_updated"
      ).textContent = `Last updated: ${data.current.last_updated}`;
      ...
      document.getElementById("pressure_mb").textContent =
